...
import {
    ...
    bookLikeOn,
    requestBook,
    saveNewPhoto, deleteBookmark, requestBookComments, setComment, setBookVerify, deleteThisComment
...
export default connect(mapStateToProps, {setChapterVerify: setBookVerify,deleteThisChapter, requestBook,saveNewPhoto,bookLikeOn,bookLikeOff,deleteThisComment, setBookMark,deleteBookmark,requestBookComments,setComment})(BookContainer)
